...
function getconstructionobra() {
  ...
  $.ajax({
    ...
    dataType: "JSON",
    async: false,
    data: { action: "get_constructions_part" },
    success: function (response) {
      res = response;
...
function get_partida(construction_ID){
  var res;
  $.ajax({
    type: "POST",
    url: "../controllers/controller.php",
    dataType: "JSON",
    async: false,
    data: {action: "get_partidas",  construction: construction_ID},
    success: function(response){
      res = response;
    },
  });
...
function get_Docs(const_id){
  ...
  $.ajax({
    ...
    dataType: "JSON",
    async: false,
    data: {action: "get_docs_types",  construction: const_id},
    success: function(response){
      res = response;
    },
  });
